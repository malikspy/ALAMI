...
String tambahEmail = 'mukti' + Time

GlobalVariable.email = tambahEmail

WebUI.setText(findTestObject('Daftar/1. Registrasi Pemberi Dana/Email'), tambahEmail + '@inboxkitten.com')
...
WebUI.click(findTestObject('Daftar/scroll'))
